...
const Page3 = () => {
  ...
  const [visualConstructionQuality, setVisualConstructionQuality] = useState("")
  ...
  return (
	<div className="container">
        ...
        <form id="formSoftStory" onSubmit={() => false}>
            ...
            <select id="soft_story" name="soft_story" required value={softStory} onChange={(e) =>setSoftStory(e.target.value)}>
        ...
        <form id="visualConstructionQuality" onSubmit={() => false}>
            <label for="visual_construction-quality">visual construction quality:</label>
            <select id="visual_construction-quality" name="visual_construction-quality" required value={visualConstructionQuality} onChange={(e) =>setVisualConstructionQuality(e.target.value)}>
                <option value="" disabled selected>-- Select --</option>
        ...
        <form id="formShortColumn" >
            ...
            <select id="short_column" name="short_column" required value={shortColumn} onChange={(e) => setshortColumn(e.target.value) }>
                <option value="" disabled selected>-- Select --</option>
                <option value="presence">Presence</option>
                <option value="absence">Absence</option>
            </select><br />
			  ...
			  <button type="button" onClick={() => {
				  dispatch(setPageThreeData({shortColumn, softStory, visualConstructionQuality}))
				  navigate("/4")
			  }}>Continue</button>
        </form>
    </div>
